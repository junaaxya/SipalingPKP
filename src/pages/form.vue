          ...
          >
            ...
            <div v-if="currentStep === 1">
              ...
              <v-row>
                ...
                <v-col
                  v-if="formData.pengisi.jabatan === 'Lainnya'"
                  cols="12"
                >
                  <v-text-field
              ...
              <v-row>
                ...
                >
                  <v-text-field
                    ...
                    variant="outlined"
                    @update:modelValue="(val) => { formData.pemilik.noTelp = sanitizeDigits(val) }"
                  />
                </v-col>
                <v-col
                  cols="12"
                ...
                >
                  <v-text-field
                    :model-value="formatPhoneNumber(formData.pemilik.noTelpKepalaKeluarga)"
                    ...
                    :rules="[rules.required, rules.phone, rules.phoneLength]"
                    variant="outlined"
                    @update:modelValue="(val) => { formData.pemilik.noTelpKepalaKeluarga = sanitizeDigits(val) }"
                  />
                </v-col>
                <v-col
                  cols="12"
                ...
                >
                  <v-text-field
                    ...
                    variant="outlined"
                    @update:modelValue="(val) => { formData.pemilik.usia = sanitizeDigits(val, 3) }"
                  />
                </v-col>
                <v-col
                  cols="12"
                ...
                >
                  <v-text-field
                    ...
                    variant="outlined"
                    @update:modelValue="(val) => { formData.pemilik.noKK = sanitizeDigits(val, 16) }"
                  />
                </v-col>
                <v-col
                  cols="12"
                ...
                >
                  <v-text-field
                    ...
                    variant="outlined"
                    @update:modelValue="(val) => { formData.pemilik.jumlahKK = sanitizeDigits(val) }"
                  />
                </v-col>
              </v-row>
              ...
              <v-row>
                ...
                >
                  <v-text-field
                    ...
                    variant="outlined"
                    @update:modelValue="(val) => { formData.pemilik.rt = sanitizeDigits(val, 3) }"
                  />
                </v-col>
                <v-col
                  cols="12"
                ...
                >
                  <v-text-field
                    ...
                    :rules="[rules.required, rules.rtRw]"
                    variant="outlined"
                    @update:modelValue="(val) => { formData.pemilik.rw = sanitizeDigits(val, 3) }"
                  />
                </v-col>
                <v-col
                  cols="12"
                ...
                >
                  <v-text-field
                    ...
                    variant="outlined"
                    @update:modelValue="(val) => { formData.pemilik.postalCode = sanitizeDigits(val, 5) }"
                  />
                </v-col>
                <v-col
                  cols="12"
                ...
                >
                  <v-text-field
                    ...
                    variant="outlined"
                    @update:modelValue="(val) => { formData.pemilik.penghasilan = sanitizeDigits(val) }"
                  />
                </v-col>
                <v-col
                  cols="12"
                ...
                >
                  <v-text-field
                    ...
                    variant="outlined"
                    @update:modelValue="(val) => { formData.pemilik.bantuanPerumahanTahun = sanitizeDigits(val, 4) }"
                  />
                </v-col>
                <v-col cols="12">
                  <v-select
                ...
                <v-col
                  v-if="formData.pemilik.kriteriaMiskin"
                  cols="12"
                >
                  <div class="mt-6">
                    <div class="d-flex flex-column flex-sm-row flex-wrap align-start align-sm-center justify-space-between gap-2 mb-3">
                      <div>
                        <h4 class="text-subtitle-1 mb-1">
                          Berkas Kriteria Miskin
                        </h4>
                        <p class="text-body-2 text-medium-emphasis mb-0">
                          Unggah bukti berkas kriteria miskin (maksimal {{ MAX_IMAGES_PER_SECTION }} foto).
                        </p>
                      </div>
                      <div class="d-flex flex-wrap gap-2">
                        <v-btn
                          ...
                          :disabled="imageProcessing.kemiskinan || formData.kemiskinan.photos.length >= MAX_IMAGES_PER_SECTION"
                    ...
                    <v-row class="g-3">
                      ...
                      >
                        ...
                        >
                          <v-img
                            ...
                            :alt="photo.name"
                          />
                          <div class="d-flex align-start align-sm-center justify-space-between gap-3">
                      ...
                      <v-col
                        v-if="formData.kemiskinan.photos.length < MAX_IMAGES_PER_SECTION"
                        cols="12"
                        sm="6"
                        md="4"
                      >
                        ...
                        >
                          ...
                          <span class="text-caption text-medium-emphasis text-center mt-1">
                            Pilih dari galeri
                          </span>
                        </v-card>
                      </v-col>
                    ...
                    <input
                      :ref="(el) => registerUploadRef('kemiskinan', 'camera', el)"
                      type="file"
                      accept="image/*"
                      capture="environment"
                    ...
                    >
                    <input
                      :ref="(el) => registerUploadRef('kemiskinan', 'gallery', el)"
                      type="file"
                      accept="image/*"
                      class="file-input-hidden"
                      multiple
              ...
              <v-row>
                ...
                >
                  <v-text-field
                    ...
                    variant="outlined"
                    @update:modelValue="(val) => { formData.rumah.luasBangunan = sanitizeDecimal(val) }"
                  />
                </v-col>
                <v-col
                  cols="12"
                ...
                >
                  <v-text-field
                    ...
                    variant="outlined"
                    @update:modelValue="(val) => { formData.rumah.luasTanah = sanitizeDecimal(val) }"
                  />
                </v-col>
                <v-col
                  cols="12"
                ...
                >
                  <v-select
                    ...
                    label="Jenis Rumah"
                    :items="['Rumah Tapak', 'Rumah Susun', 'Rumah Petak', 'Kos']"
                    :rules="[rules.required]"
                    variant="outlined"
                  />
                </v-col>
                <v-col cols="12">
                  <v-text-field
                    ...
                    variant="outlined"
                    @update:modelValue="(val) => { formData.rumah.jumlahPenghuni = sanitizeDigits(val) }"
                  />
                </v-col>
              </v-row>
              ...
              <div class="mt-6">
                <div class="d-flex flex-column flex-sm-row flex-wrap align-start align-sm-center justify-space-between gap-2 mb-3">
                  <div>
                    ...
                    <p class="text-body-2 text-medium-emphasis mb-0">
                      Unggah maksimal {{ MAX_IMAGES_PER_SECTION }} foto kondisi rumah. Ukuran tiap foto hingga {{ MAX_IMAGE_SIZE_MB }}MB.
                    </p>
                  </div>
                  <div class="d-flex flex-wrap gap-2">
                    <v-btn
                      ...
                      :disabled="imageProcessing.rumah || formData.rumah.photos.length >= MAX_IMAGES_PER_SECTION"
            ...
            <div v-if="currentStep === 4">
              <h3 class="text-h6 mb-4">
                3.2 Aspek Komposisi Bahan Bangunan
              </h3>
              <v-row>
                <v-col
                  cols="12"
                ...
                >
                  <v-select
                    ...
                    label="Lantai"
                    :items="['Tanah', 'Keramik', 'Rabat Semen', 'Papan', 'Kayu', 'Bata']"
                    :rules="[rules.required]"
                    variant="outlined"
                  />
                </v-col>
              ...
              <div class="mt-6">
                <div class="d-flex flex-column flex-sm-row flex-wrap align-start align-sm-center justify-space-between gap-2 mb-3">
                  <div>
                    ...
                    <p class="text-body-2 text-medium-emphasis mb-0">
                      Unggah maksimal {{ MAX_IMAGES_PER_SECTION }} foto material bangunan. Ukuran tiap foto hingga {{ MAX_IMAGE_SIZE_MB }}MB.
                    </p>
                  </div>
                  <div class="d-flex flex-wrap gap-2">
                    <v-btn
                      ...
                      :disabled="imageProcessing.bangunan || formData.bangunan.photos.length >= MAX_IMAGES_PER_SECTION"
                ...
                <v-row class="g-3">
                  ...
                  <v-col
                    v-if="formData.bangunan.photos.length < MAX_IMAGES_PER_SECTION"
                    cols="12"
                    sm="6"
                    md="4"
                  >
              ...
              <v-row>
                ...
                >
                  <v-select
                    ...
                    :items="['Sumur Gali', 'Sumur Bor', 'Ledeng', 'Sumber Air Lainnya']"
                    :rules="[rules.required]"
                    variant="outlined"
                  />
                </v-col>
                ...
                >
                  <v-text-field
                    ...
                    variant="outlined"
                    @update:modelValue="(val) => { formData.kesehatan.kedalamanSumurBor = sanitizeDigits(val) }"
                  />
                </v-col>
                <v-col
                  cols="12"
                ...
                >
                  <v-select
                    ...
                    :items="['Di Dalam Tanah Sendiri', 'Menumpang/Mengambil dari Tempat Lain']"
                    :rules="[rules.required]"
                    variant="outlined"
                  />
                </v-col>
                ...
                >
                  <v-select
                    ...
                    :items="['Sumur Gali', 'Sumur Bor', 'Ledeng', 'Air Isi Ulang', 'Sumber Air Lainnya']"
                    :rules="[rules.required]"
                    variant="outlined"
                  />
                </v-col>
                ...
                >
                  <v-text-field
                    ...
                    :rules="[rules.depthRange]"
                    variant="outlined"
                    @update:modelValue="(val) => { formData.kesehatan.kedalamanSumurBorMinum = sanitizeDigits(val) }"
                  />
                </v-col>
              </v-row>
              ...
              <div class="mt-6">
                <div class="d-flex flex-column flex-sm-row flex-wrap align-start align-sm-center justify-space-between gap-2 mb-3">
                  <div>
                    ...
                    <p class="text-body-2 text-medium-emphasis mb-0">
                      Unggah maksimal {{ MAX_IMAGES_PER_SECTION }} foto terkait akses air bersih. Ukuran tiap foto hingga {{ MAX_IMAGE_SIZE_MB }}MB.
                    </p>
                  </div>
                  <div class="d-flex flex-wrap gap-2">
                    <v-btn
                      ...
                      :disabled="imageProcessing.kesehatan || formData.kesehatan.photos.length >= MAX_IMAGES_PER_SECTION"
                ...
                <v-row class="g-3">
                  ...
                  <v-col
                    v-if="formData.kesehatan.photos.length < MAX_IMAGES_PER_SECTION"
                    cols="12"
                    sm="6"
                    md="4"
                  >
              ...
              <v-row>
                ...
                >
                  <v-select
                    ...
                    :items="['Milik Sendiri', 'Jamban Bersama', 'Tidak Memiliki Jamban']"
                    :rules="[rules.required]"
                    variant="outlined"
                  />
                </v-col>
                <v-col
                  v-if="formData.sanitasi.kepemilikanJamban !== 'Tidak Memiliki Jamban'"
                  cols="12"
                  md="6"
                >
                  <v-text-field
                    ...
                    variant="outlined"
                    @update:modelValue="(val) => { formData.sanitasi.jumlahJamban = sanitizeDigits(val) }"
                  />
                </v-col>
                <v-col
                  cols="12"
                ...
                >
                  <v-select
                    ...
                    label="Jenis Closet"
                    :items="['Cubluk', 'Leher Angsa (Jongkok)', 'Leher Angsa (Duduk)']"
                    :rules="[rules.required]"
                    variant="outlined"
                  />
                </v-col>
                ...
                >
                  <v-select
                    ...
                    :items="['Biotank', 'Tanki dengan Konstruksi Permanen', 'Lubang Tanah', 'Tidak Memiliki Tanki']"
                    :rules="[rules.required]"
                    variant="outlined"
                  />
                </v-col>
                <v-col
                  v-if="formData.sanitasi.jenisTangkiSeptic !== 'Tidak Memiliki Tanki'"
                  cols="12"
                  md="6"
                >
                  <v-text-field
                    ...
                    :rules="[rules.year]"
                    variant="outlined"
                    @update:modelValue="(val) => { formData.sanitasi.tahunPembuatanTangki = sanitizeDigits(val, 4) }"
                  />
                </v-col>
                <v-col
                  v-if="formData.sanitasi.jenisTangkiSeptic !== 'Tidak Memiliki Tanki'"
                ...
                >
                  <v-text-field
                    ...
                    :rules="[rules.year]"
                    variant="outlined"
                    @update:modelValue="(val) => { formData.sanitasi.tahunPenyedotan = sanitizeDigits(val, 4) }"
                  />
                </v-col>
                <v-col
                  v-if="formData.sanitasi.pernahPenyedotan === 'Ya'"
              ...
              <div class="mt-6">
                <div class="d-flex flex-column flex-sm-row flex-wrap align-start align-sm-center justify-space-between gap-2 mb-3">
                  <div>
                    ...
                    <p class="text-body-2 text-medium-emphasis mb-0">
                      Unggah maksimal {{ MAX_IMAGES_PER_SECTION }} foto fasilitas sanitasi. Ukuran tiap foto hingga {{ MAX_IMAGE_SIZE_MB }}MB.
                    </p>
                  </div>
                  <div class="d-flex flex-wrap gap-2">
                    <v-btn
                      ...
                      :disabled="imageProcessing.sanitasi || formData.sanitasi.photos.length >= MAX_IMAGES_PER_SECTION"
                ...
                <v-row class="g-3">
                  ...
                  <v-col
                    v-if="formData.sanitasi.photos.length < MAX_IMAGES_PER_SECTION"
                    cols="12"
                    sm="6"
                    md="4"
                  >
              ...
              <v-row>
                ...
                >
                  <v-select
                    ...
                    :items="['Pemda', 'Pemdes', 'LSM/Kelompok Masyarakat', 'Lainnya']"
                    :rules="[rules.required]"
                    variant="outlined"
                  />
                </v-col>
                <v-col
                  v-if="formData.persampahan.pengelolaPengangkutanSampah === 'Lainnya'"
                  cols="12"
                >
                  <v-text-field
                ...
                <v-col
                  v-if="formData.persampahan.aksesPengangkutanSampah === 'Tidak'"
                  cols="12"
                >
                  <v-select
              ...
              <div class="mt-6">
                <div class="d-flex flex-column flex-sm-row flex-wrap align-start align-sm-center justify-space-between gap-2 mb-3">
                  <div>
                    ...
                    <p class="text-body-2 text-medium-emphasis mb-0">
                      Unggah maksimal {{ MAX_IMAGES_PER_SECTION }} foto terkait pengelolaan sampah. Ukuran tiap foto hingga {{ MAX_IMAGE_SIZE_MB }}MB.
                    </p>
                  </div>
                  <div class="d-flex flex-wrap gap-2">
                    <v-btn
                      ...
                      :disabled="imageProcessing.persampahan || formData.persampahan.photos.length >= MAX_IMAGES_PER_SECTION"
                ...
                <v-row class="g-3">
                  ...
                  <v-col
                    v-if="formData.persampahan.photos.length < MAX_IMAGES_PER_SECTION"
                    cols="12"
                    sm="6"
                    md="4"
                  >
              ...
              <div class="mt-6">
                <div class="d-flex flex-column flex-sm-row flex-wrap align-start align-sm-center justify-space-between gap-2 mb-3">
                  <div>
                    ...
                    <p class="text-body-2 text-medium-emphasis mb-0">
                      Unggah maksimal {{ MAX_IMAGES_PER_SECTION }} foto akses jalan. Ukuran tiap foto hingga {{ MAX_IMAGE_SIZE_MB }}MB.
                    </p>
                  </div>
                  <div class="d-flex flex-wrap gap-2">
                    <v-btn
                      ...
                      :disabled="imageProcessing.jalan || formData.jalan.photos.length >= MAX_IMAGES_PER_SECTION"
              ...
              <v-row>
                ...
                >
                  <v-select
                    ...
                    :items="['PLN Sendiri', 'PLN Menumpang', 'Tidak Ada', 'Lainnya']"
                    :rules="[rules.required]"
                    variant="outlined"
                  />
                </v-col>
                ...
                <v-col
                  v-if="formData.energi.sumberListrik === 'PLN Sendiri' || formData.energi.sumberListrik === 'PLN Menumpang'"
                  cols="12"
                >
                  <v-text-field
                    ...
                    variant="outlined"
                    @update:modelValue="(val) => { formData.energi.kapasitasListrik = sanitizeDigits(val) }"
                  />
                </v-col>
              </v-row>
              ...
              <div class="mt-6">
                <div class="d-flex flex-column flex-sm-row flex-wrap align-start align-sm-center justify-space-between gap-2 mb-3">
                  <div>
                    ...
                    <p class="text-body-2 text-medium-emphasis mb-0">
                      Unggah maksimal {{ MAX_IMAGES_PER_SECTION }} foto akses energi. Ukuran tiap foto hingga {{ MAX_IMAGE_SIZE_MB }}MB.
                    </p>
                  </div>
                  <div class="d-flex flex-wrap gap-2">
                    <v-btn
                      ...
                      :disabled="imageProcessing.energi || formData.energi.photos.length >= MAX_IMAGES_PER_SECTION"
                ...
                <v-row class="g-3">
                  ...
                  <v-col
                    v-if="formData.energi.photos.length < MAX_IMAGES_PER_SECTION"
                    cols="12"
                    sm="6"
                    md="4"
                  >
                ...
                >
                  <v-card>
                    ...
                    <v-card-text>
                      ...
                      <p><strong>Email:</strong> {{ formData.pengisi.email }}</p>
                      <p><strong>Jabatan:</strong> {{ formData.pengisi.jabatan }}</p>
                    </v-card-text>
                  </v-card>
                </v-col>
                <v-col
                ...
                >
                  <v-card>
                    ...
                    <v-card-text>
                      ...
                      <p><strong>Lokasi:</strong> {{ ownerLocationSummary || '-' }}</p>
                      <p><strong>Alamat:</strong> {{ ownerAddressSummary || '-' }}</p>
                      <p>
                        <strong>RT/RW:</strong>
                        {{ formData.pemilik.rt || '-' }}/{{ formData.pemilik.rw || '-' }}
                      </p>
                      <p><strong>Kode Pos:</strong> {{ formData.pemilik.postalCode || '-' }}</p>
                      <p><strong>Status Rumah:</strong> {{ formData.pemilik.statusKepemilikanRumah }}</p>
                    </v-card-text>
                  </v-card>
                </v-col>
              </v-row>
...
const rules = {
  ...
  phoneLength: (value) => {
    ...
    return (digits.length >= PHONE_MIN && digits.length <= PHONE_MAX) || `No. Telp harus ${PHONE_MIN}-${PHONE_MAX} digit`
  },
  kkRange: createRangeRule(KK_MIN, KK_MAX, 'Jumlah KK'),
  occupantsRange: createRangeRule(OCCUPANTS_MIN, OCCUPANTS_MAX, 'Jumlah penghuni'),
  ...
  electricityRange: createRangeRule(ELECTRICITY_MIN, ELECTRICITY_MAX, 'Kapasitas listrik'),
  ...
  age: (value) => {
    ...
    return (age >= AGE_MIN && age <= AGE_MAX) || `Usia harus ${AGE_MIN}-${AGE_MAX}`
  },
  positive: (value) => {
...
const imageSections = ['rumah', 'bangunan', 'kesehatan', 'sanitasi', 'persampahan', 'jalan', 'energi', 'kemiskinan']
...
const buildDraftPayload = () => {
  const draft = JSON.parse(JSON.stringify(formData, (key, value) => {
    if (key === 'photos') {
      return []
    }
    return value
  ...
  try {
    ...
    if (response?.success && Array.isArray(response.data?.provinces)) {
      const provinces = response.data.provinces.map((province) => {
        ...
        return {
          id,
          name: province.name || province.nama || province.label || province.text || '',
          code: province.code
        }
      }).filter(Boolean)
      ...
      locationSelectError.value = response?.message || 'Gagal memuat data provinsi.'
    }
  } catch (error) {
...
const fetchRegencies = async (provinceId) => {
  ...
  try {
    ...
    if (response?.success && Array.isArray(response.data?.regencies)) {
      const regencies = response.data.regencies.map((regency) => {
        const id = resolveLocationId(regency)
        if (!id) return null
        return {
          id,
          name: regency.name || regency.nama || regency.label || regency.text || '',
          code: regency.code,
          type: regency.type
        }
      }).filter(Boolean)
      ...
      locationSelectError.value = response?.message || 'Gagal memuat data kabupaten/kota.'
    }
  } catch (error) {
  ...
  try {
    ...
    if (response?.success && Array.isArray(response.data?.districts)) {
      const districts = response.data.districts.map((district) => {
        ...
        return {
          id,
          name: district.name || district.nama || district.label || district.text || '',
          code: district.code
        }
      }).filter(Boolean)
      ...
      locationSelectError.value = response?.message || 'Gagal memuat data kecamatan.'
    }
  } catch (error) {
  ...
  try {
    ...
    if (response?.success && Array.isArray(response.data?.villages)) {
      const villages = response.data.villages.map((village) => {
        ...
        return {
          id,
          name: village.name || village.nama || village.label || village.text || '',
          code: village.code
        }
      }).filter(Boolean)
      ...
      locationSelectError.value = response?.message || 'Gagal memuat data kelurahan.'
    }
  } catch (error) {
...
const setLocationHierarchy = async ({ province, regency, district, village }) => {
  ...
  try {
    ...
    const regencyId = resolveLocationId(regency)
    if (regencyId) {
      const parentProvinceId = regency.parentId || provinceId || formData.pemilik.province?.id
    ...
    const districtId = resolveLocationId(district)
    if (districtId) {
      const parentRegencyId = district.parentId || regencyId || formData.pemilik.regency?.id
    ...
    if (villageId) {
      const parentDistrictId = village.parentId || districtId || formData.pemilik.district?.id
...
const handleLocationPicked = async ({ latitude, longitude }) => {
  ...
  try {
    ...
    locationSyncMessage.value = 'Lokasi berhasil disinkronkan berdasarkan titik peta.'
    if (formRef.value) {
...
const normalizeLegacyDraft = (draftPemilik) => {
  ...
  if (!draftPemilik.bantuanPerumahanStatus && typeof draftPemilik.bantuanPerumahan === 'string') {
  ...
  if (!draftPemilik.kriteriaMiskin && typeof draftPemilik.teregistrasiMiskin === 'string') {
  ...
  const buildDraftFromSubmission = (submission) => {
    ...
    return {
      ...
      pemilik: {
        ...
        statusKepemilikanTanah: mapLandOwnershipFromApi(owner.landOwnershipStatus),
        statusKepemilikanRumah: mapHouseOwnershipFromApi(owner.houseOwnershipStatus),
      ...
      sanitasi: {
        ...
        jasaSedotTinja: mapSepticPumpingServiceFromApi(sanitation.septicPumpingService),
        pengaliranAirLimbah: mapWastewaterDisposalFromApi(sanitation.wastewaterDisposal),
        photos: []
      },
      persampahan: {
        aksesPengangkutanSampah: mapWasteCollectionFromApi(waste.hasWasteCollection),
        pengelolaPengangkutanSampah: mapWasteCollectionManagerFromApi(waste.wasteCollectionManager),
        pengelolaLainnya: waste.wasteCollectionManagerOther || '',
        pengelolaanSampah: mapWasteDisposalMethodFromApi(waste.wasteDisposalMethod),
        photos: []
      },
      jalan: {
  ...
  const loadSubmissionForEdit = async (submissionId) => {
    ...
    try {
      ...
      editSubmissionNotes.value = submission.reviewNotes || submission.verificationNotes || ''
...
const applyLocationResult = async (result) => {
  ...
  formData.pemilik.postalCode = result.postalCode || formData.pemilik.postalCode
  ...
  try {
    ...
    if (response.success && response.data) {
      ...
      if (!mapped?.province?.id) {
        ...
        locationSyncType.value = 'error'
        locationSyncMessage.value = 'Data lokasi dari layanan geocode tidak lengkap. Silakan pilih lokasi secara manual.'
      ...
      locationSyncType.value = 'error'
      locationSyncMessage.value = response.message || 'Lokasi tidak ditemukan. Silakan pilih lokasi secara manual.'
    ...
    if (!locationSyncMessage.value) {
      locationSyncType.value = 'error'
      locationSyncMessage.value = error?.message || 'Lokasi tidak ditemukan. Silakan pilih lokasi secara manual.'
    }
    throw error
  }
}
...
async function onImageSelected(section, source, event) {
  ...
  if (availableSlots <= 0) {
    imageErrors[section] = `Maksimal ${MAX_IMAGES_PER_SECTION} foto untuk bagian ini.`
...
const requiresValidation = computed(() => validationRequiredSteps.includes(currentStep.value))
  ...
  try {
    ...
    const apiFormData = {
      ...
      respondent: {
        ...
        positionOther: formData.pengisi.jabatan === 'Lainnya' ? formData.pengisi.jabatanLainnya : null,
      ...
      householdOwnerData: {
        ...
        educationLevelOther: formData.pemilik.pendidikan === 'Lainnya' ? formData.pemilik.pendidikan : null,
        occupation: formData.pemilik.pekerjaan,
        monthlyIncome: parseFloat(formData.pemilik.penghasilan),
        
        // Ownership Status
        landOwnershipStatus: mapLandOwnership(formData.pemilik.statusKepemilikanTanah),
        houseOwnershipStatus: mapHouseOwnership(formData.pemilik.statusKepemilikanRumah),
        
        // Assistance History
        hasReceivedHousingAssistance: formData.pemilik.bantuanPerumahanStatus === 'Ya',
        housingAssistanceYear: formData.pemilik.bantuanPerumahanStatus === 'Ya'
          ? parseInt(formData.pemilik.bantuanPerumahanTahun) || null
          : null,
        isRegisteredAsPoor: Boolean(formData.pemilik.kriteriaMiskin),
        poorRegistrationAttachment: formData.pemilik.kriteriaMiskin === 'Lainnya'
      ...
      houseData: {
        ...
        wallMaterialOther: formData.bangunan.dinding === 'Lainnya' ? formData.bangunan.dinding : null,
        roofMaterial: mapRoofMaterial(formData.bangunan.atap),
        roofMaterialOther: formData.bangunan.atap === 'Lainnya' ? formData.bangunan.atap : null
      },
      
      // Water Access
      waterAccess: {
        sanitationWaterSource: mapWaterSource(formData.kesehatan.sumberAirMCK),
        sanitationWaterSourceOther: formData.kesehatan.sumberAirMCK === 'Sumber Air Lainnya' ? formData.kesehatan.sumberAirMCK : null,
        sanitationWaterDepth: formData.kesehatan.sumberAirMCK === 'Sumur Bor' ? parseInt(formData.kesehatan.kedalamanSumurBor) : null,
        ...
        drinkingWaterSourceOther: formData.kesehatan.sumberAirMinum === 'Sumber Air Lainnya' ? formData.kesehatan.sumberAirMinum : null,
        drinkingWaterDepth: formData.kesehatan.sumberAirMinum === 'Sumur Bor' ? parseInt(formData.kesehatan.kedalamanSumurBorMinum) : null
      },
      
      // Sanitation Access
      sanitationAccess: {
        toiletOwnership: mapToiletOwnership(formData.sanitasi.kepemilikanJamban),
        toiletCount: formData.sanitasi.kepemilikanJamban !== 'Tidak Memiliki Jamban' ? parseInt(formData.sanitasi.jumlahJamban) : 0,
        ...
        septicTankYear: formData.sanitasi.jenisTangkiSeptic !== 'Tidak Memiliki Tanki' ? parseInt(formData.sanitasi.tahunPembuatanTangki) : null,
        hasSepticPumping: formData.sanitasi.pernahPenyedotan === 'Ya',
        septicPumpingYear: formData.sanitasi.pernahPenyedotan === 'Ya' ? parseInt(formData.sanitasi.tahunPenyedotan) : null,
        septicPumpingService: mapSepticPumpingService(formData.sanitasi.jasaSedotTinja),
        
        wastewaterDisposal: mapWastewaterDisposal(formData.sanitasi.pengaliranAirLimbah)
      },
      
      // Waste Management
      wasteManagement: {
        hasWasteCollection: mapWasteCollection(formData.persampahan.aksesPengangkutanSampah),
        wasteCollectionManager: mapWasteCollectionManager(formData.persampahan.pengelolaPengangkutanSampah),
        wasteCollectionManagerOther: formData.persampahan.pengelolaPengangkutanSampah === 'Lainnya' ? formData.persampahan.pengelolaLainnya : null,
        
        wasteDisposalMethod: mapWasteDisposalMethod(formData.persampahan.pengelolaanSampah),
        wasteDisposalLocation: formData.persampahan.pengelolaanSampah === 'Dibuang di Tempat Lainnya' ? formData.persampahan.pengelolaanSampah : null
      },
      ...
      roadAccess: {
        ...
        roadConstructionOther: formData.jalan.konstruksiJalan === 'Konstruksi Lainnya' ? formData.jalan.konstruksiLainnya : null
      },
      
      // Energy Access
      energyAccess: {
        electricitySource: mapElectricitySource(formData.energi.sumberListrik),
        electricitySourceOther: formData.energi.sumberListrik === 'Lainnya' ? formData.energi.sumberListrikLainnya : null,
        plnCapacity: (formData.energi.sumberListrik === 'PLN Sendiri' || formData.energi.sumberListrik === 'PLN Menumpang') ? formData.energi.kapasitasListrik : null
      }
    }
    ...
    appendPhotoFiles(formPayload, 'houseStructurePhotos', formData.bangunan.photos)
    appendPhotoFiles(formPayload, 'waterAccessPhotos', formData.kesehatan.photos)
    appendPhotoFiles(formPayload, 'sanitationAccessPhotos', formData.sanitasi.photos)
    appendPhotoFiles(formPayload, 'wasteManagementPhotos', formData.persampahan.photos)
...
const mapWaterLocation = (value) => {
  return value === 'Di Dalam Tanah Sendiri' ? 'di_tanah_sendiri' : 'menumpang_tempat_lain'
}
...
const mapRoadType = (value) => {
  const mapping = {
    ...
    'Tidak Terdapat Jalan Akses/Melalui Perkarangan Orang Lain': 'tidak_ada_akses'
  }
...
// Energy Access Mapping
  ...
  const mapFromApiValue = (value, mapping, fallback = '') => {
    ...
    const entry = Object.entries(mapping).find(([, apiValue]) => apiValue === value)
    return entry ? entry[0] : fallback
  }

  const mapRelationshipFromApi = (value) => mapFromApiValue(value, {
    'Perangkat Desa/Kelurahan': 'perangkat_desa',
    'Pemilik Rumah': 'pemilik_rumah',
    'Lainnya': 'lainnya'
  }, 'Lainnya')

  const mapEducationLevelFromApi = (value) => mapFromApiValue(value, {
    'Tidak Sekolah': 'tidak_sekolah',
    'SD/Sederajat': 'sd',
    'SMP/Sederajat': 'smp',
    'SMA/Sederajat': 'sma',
  ...
  const mapLandOwnershipFromApi = (value) => mapFromApiValue(value, {
    'Milik Sendiri': 'milik_sendiri',
    'Bukan Milik Sendiri': 'bukan_milik_sendiri'
  }, 'Bukan Milik Sendiri')

  const mapHouseOwnershipFromApi = (value) => mapFromApiValue(value, {
    'Milik Sendiri': 'milik_sendiri',
    'Sewa': 'sewa',
    'Menumpang': 'menumpang'
  }, 'Menumpang')

  const mapHouseTypeFromApi = (value) => mapFromApiValue(value, {
    'Rumah Tapak': 'rumah_tapak',
    'Rumah Susun': 'rumah_susun',
    'Rumah Petak': 'rumah_petak',
    'Kos': 'kos'
  ...
  const mapFloorMaterialFromApi = (value) => mapFromApiValue(value, {
    'Tanah': 'tanah',
    'Keramik': 'keramik',
    'Rabat Semen': 'rabat_semen',
    'Papan': 'papan',
  ...
  const mapWallMaterialFromApi = (value) => mapFromApiValue(value, {
    'Tembok/Bata/Batako Tanpa Plester': 'tembok_tanpa_plester',
    'Tembok Bata/Batako dengan Plester': 'tembok_dengan_plester',
    'Papan': 'papan',
    'Anyaman Bambu': 'anyaman_bambu',
  ...
  const mapRoofMaterialFromApi = (value) => mapFromApiValue(value, {
    'Genteng (Beton/Keramik)': 'genteng_beton',
    'Seng/Multiroof': 'seng_multiroof',
    'Kayu/Sirap': 'kayu_sirap',
    'Asbes': 'asbes',
  ...
  const mapWaterSourceFromApi = (value) => mapFromApiValue(value, {
    'Sumur Gali': 'sumur_gali',
    'Sumur Bor': 'sumur_bor',
    'Ledeng': 'ledeng',
    'Sumber Air Lainnya': 'lainnya'
  ...
  const mapWaterLocationFromApi = (value) => mapFromApiValue(value, {
    'Di Dalam Tanah Sendiri': 'di_tanah_sendiri',
    'Menumpang/Mengambil dari Tempat Lain': 'menumpang_tempat_lain'
  }, '')

  const mapToiletOwnershipFromApi = (value) => mapFromApiValue(value, {
    'Milik Sendiri': 'milik_sendiri',
    'Jamban Bersama': 'jamban_bersama',
    'Tidak Memiliki Jamban': 'tidak_memiliki'
  }, '')

  const mapToiletTypeFromApi = (value) => mapFromApiValue(value, {
    'Cubluk': 'cubluk',
    'Leher Angsa (Jongkok)': 'leher_angsa_jongkok',
    'Leher Angsa (Duduk)': 'leher_angsa_duduk'
  }, '')

  const mapSepticTankTypeFromApi = (value) => mapFromApiValue(value, {
    'Biotank': 'biotank',
    'Tanki dengan Konstruksi Permanen': 'tanki_permanen',
    'Lubang Tanah': 'lubang_tanah',
    'Tidak Memiliki Tanki': 'tidak_memiliki'
  ...
  const mapSepticPumpingServiceFromApi = (value) => mapFromApiValue(value, {
    'Pemda': 'pemda',
    'Swasta (Perorangan/Badan Usaha)': 'swasta_perorangan'
  }, '')

  const mapWastewaterDisposalFromApi = (value) => mapFromApiValue(value, {
    'Tergabung dalam Jaringan Pipa Pengolahan Air Limbah': 'jaringan_pipa',
    'Tergabung dalam Tangki Septic': 'tangki_septic',
    'Langsung Dialirkan ke Drainase/Saluran/Sungai': 'drainase_sungai',
    'Ditampung dalam Lubang/Resapan ke Tanah': 'resapan_tanah'
  ...
  const mapWasteCollectionManagerFromApi = (value) => mapFromApiValue(value, {
    'Pemda': 'pemda',
    'Pemdes': 'pemdes',
    'LSM/Kelompok Masyarakat': 'lsm_kelompok_masyarakat',
    'Lainnya': 'swasta'
  ...
  const mapWasteDisposalMethodFromApi = (value) => mapFromApiValue(value, {
    'Dibakar': 'dibakar',
    'Diolah di Rumah (Kompos/Ditimbun)': 'diolah_rumah',
    'Dibuang ke Tempat Sampah Umum': 'tempat_sampah_umum',
    'Dibuang di Tempat Lainnya': 'dibuang_lainnya'
  ...
  const mapRoadTypeFromApi = (value) => mapFromApiValue(value, {
    'Jalan Lebar < 3,5 m': 'lebar_kurang_3_5m',
    'Jalan Lebar > 3,5 m': 'lebar_lebih_3_5m',
    'Tidak Terdapat Jalan Akses/Melalui Perkarangan Orang Lain': 'tidak_ada_akses'
  }, '')

  const mapRoadConstructionFromApi = (value) => mapFromApiValue(value, {
    'Jalan Beton': 'beton',
    'Jalan Aspal': 'aspal',
    'Jalan Konblok': 'konblok',
    'Jalan Tanah/Sirtu': 'tanah_sirtu',
  ...
  const mapElectricitySourceFromApi = (value) => mapFromApiValue(value, {
    'PLN Sendiri': 'pln_sendiri',
    'PLN Menumpang': 'pln_menumpang',
    'Tidak Ada': 'tidak_ada',
    'Lainnya': 'lainnya'
...
const resetForm = () => {
  ...
  Object.keys(formData).forEach(section => {
    Object.keys(formData[section]).forEach(field => {
      ...
      } else if (section === 'pemilik' && (field === 'latitude' || field === 'longitude')) {
        formData[section][field] = null
      } else if (field === 'photos' && Array.isArray(formData[section][field])) {
        releaseSectionPhotos(section)
